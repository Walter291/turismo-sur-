...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>Turismo Real</b> Funcionario</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Turismo Real</b> Funcionario</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Desarrollo sistema Turismo Real</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../../../cliente/index.php" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
...
?>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Ingresar entrada </a></li>            
          </ul>
      </li>

      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Check Out</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="checkout.php"><i class="fa fa-circle-o"></i> Ingresar Salida </a></li>            
          </ul>
      </li>
