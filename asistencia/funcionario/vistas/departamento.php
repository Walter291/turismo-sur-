...
<div class="box-header with-border">
  <h1 class="box-title">Ingreso de entrada <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
