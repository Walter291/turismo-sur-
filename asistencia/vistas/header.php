...
<html>
  <head>
   ...
   <title>Turismo Real | Funcionario</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>Turismo Real </b> A</span>
...
-->
      ...
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Ingreso de entrada</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Check In</a></li>            
          </ul>
      </li>
      ...
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Ingreso de salida</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
