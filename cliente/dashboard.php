			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						</br></br><h2 class="page-title">hoteleria</h2>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">Mi Cuarto</div>

												</div>
											</div>
											<a href="room-details.php" class="block-anchor panel-footer text-center">Ver Todo &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
