...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Reportes Clientes ..::</title>
...
<body>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Casos Clientes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Casos de Clientes</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarReportesClientes.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID REPORTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID del Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="IDReporteriaClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el ID del Reporte..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el ID del Reporte...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO REPORTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el C&oacute;digo del Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODReporteriaClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el C&oacute;digo del Reporte..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Nombre del Cliente Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="100" name="NOMReporteriaClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Nombre del Cliente Reporte..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select name="NOMREmpleadoreporteriaClientes" data-toggle="tooltip-pink" data-placement="top" title="Su nombre de empleado" required class="form-control prohibido">
                                            ...
                                            <!-- PRODUCTO REPORTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Nombre del Producto Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="100" name="PRODReporteriaClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Nombre del Producto Reporte..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- MARCA REPORTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Nombre de la Marca Producto Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="100" name="MARCReporteriaClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Nombre de la Marca Producto Reporte..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <!-- en proceso y cerrado otras opciones -->
                                                <!--option value="Media">Media</option>
                                                <option value="Alta">Alta</option-->
                                            </select>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Fecha de Registro Caso Cliente <span class="CampoObligatorio">(*)</span></label>
                                                <input class="form-control prohibido" type="text" name="FechaRegistroCasoCliente" data-toggle="tooltip-pink" data-placement="top" title="Por Favor No Modificar" maxlength="10" minlength="10" data-mask="99/99/9999" value="">
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    <strong>¡No modificar este campo! por favor actualize est&aacute; p&aacute;gina</strong>
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el Detalle de Problema Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <textarea rows="5" name="DETAPROReporteriaClientes" minlength="5" maxlength="1000" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Caso del Cliente a Registrar..." data-toggle="tooltip-pink" data-placement="top" title="Solicitar y anexar informaci&oacute;n de cont&aacute;cto del cliente aqu&iacute;" value="" required></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Reporte de Cliente</button>
                                        <button class="btn btn-gradient-info" type="reset"><i class="fa fa-bitbucket"></i> Limpiar Formulario</button>
                                    </form>
                                </div>
                            </div>
            </div>
   ...
   <!-- /HK Wrapper -->
    ...
    <script src="../Vista/vendors/moment/min/moment.min.js"></script>
    <script src="../Vista/vendors/daterangepicker/daterangepicker.js"></script>
    <script src="../Vista/dist/js/daterangepicker-data.js"></script>
