			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						</br></br><h2 class="page-title">MANTENCION DE DATOS DE LOS DEPARTAMENTOS</h2>
...
?>
													...
													<div class="stat-panel-title text-uppercase"> HABITACIONES UTILIZADAS</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">TOTAL DE HABITACIONES </div>
												</div>
											</div>
