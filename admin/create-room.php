			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Agregar una habitacion </h2>
...
<?php } ?>
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Seleccionar nro de piezas  </label>
												<div class="col-sm-8">
												<Select name="seater" class="form-control" required>
<option value="">Seleccionar cantidad de piezas</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">No. de de la habitacion</label>
<div class="col-sm-8">
...
<input class="btn btn-primary" type="submit" name="submit" value="Crear Cuarto ">
												</div>
											</div>
