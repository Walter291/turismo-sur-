...
$stmt1->execute();
echo"<script>alert('Registro de Estudiante Satisfactorio');</script>";
}
?>
...
<head>
	...
	<title>Cliente hotel registrarse </title>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading">Se debe llenar todo el formulario</div>
									<div class="panel-body">
										<form method="post" action="" class="form-horizontal">
											
										
<div class="form-group">
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Información Relacionada a la habitación </h4> </label>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">No de la habitacion. </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">numero de  Habitaciones</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Tarifas mes</label>
<div class="col-sm-8">
...
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked"> Sin Comida
...
<option value="">Selecciona duracción en Meses</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Número de Contacto de Emergencia : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-5 control-label">Es la misma dirección de correspondencia? : </label>
<div class="col-sm-4">
...
<input type="submit" name="submit" Value="Registro" class="btn btn-primary">
</div>
</form>
