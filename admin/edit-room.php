			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						</br></br><h2 class="page-title">Editar Detalles de la habitacion </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Detalles de la habitacion</div>
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
				 ...
				 <div class="form-group">
				<label class="col-sm-2 control-label">Numero de habitacion </label>
		<div class="col-sm-8">
	<input type="text" class="form-control" name="rmno" id="rmno" value="<?php echo $row->room_no;?>" disabled>
	<span class="help-block m-b-none">
													El número de la habitacion no puede ser cambiado.</span>
						 </div>
						</div>
<div class="form-group">
...
<?php } ?>
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Actualizar detalles de cuarto ">
												</div>
											</div>
